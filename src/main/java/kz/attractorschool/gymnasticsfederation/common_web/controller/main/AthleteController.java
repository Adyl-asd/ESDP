...
import kz.attractorschool.gymnasticsfederation.common_service.report_service.pdf_exporter.AthletePdfExporter;
...
public class AthleteController {
    ...
    public String one(@PathVariable Integer id, Model model){
        ...
        model.addAttribute("coaches", service.presentCoaches(id));
